				...
				<div class="portlet portlet-default">
					...
					<div class="portlet-footer">
						...
						<div align="center"> <!-- 검색 완료시 (등록/수정) 버튼이 보이게 조건 추가.   -->
 							<!-- <button type="button" class="btn btn-default" style="height:40px; width:100px;" onclick="openButton(0);">등&nbsp;&nbsp;록</button>
							<button type="button" class="btn btn-default" style="height:40px; width:100px;" onclick="openButton(1);">수&nbsp;&nbsp;정</button> -->
