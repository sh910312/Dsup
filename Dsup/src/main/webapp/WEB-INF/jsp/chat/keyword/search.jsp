...
<div class="container">
							...
							<div class="portlet-footer">
								<div class="row" >
									<div class="form-group col-xs-10">
										...
										<button type="button" class="btn btn-default" style="height:40px; width:100px;" onclick="#">검&nbsp;&nbsp;색</button>
								</div>
								<div class="row">
	...
	<form>
		제목 <input name="title"> 정렬 <select name="orderby">
			<option value="">선택
	...
	<form action="deleteBoardList">
		...
		<c:forEach items="${boardList}" var="board">
			<div>
				...
				${board.seq } <a href="getBoard?seq=${board.seq }">${board.title }</a>
				${board.regDate } ${board.uploadFilename}
			</div>
		</c:forEach>
